...
public class Shuriken : Weapon {
	...
	void Update()
	{
        ...
        if (roundManager.currentState == global::State.Playing && gameObject.activeSelf == true)
		{
	...
	void Spin(){
        if (roundManager.currentState == global::State.Playing) {//currentState == starState.Shoot && 
